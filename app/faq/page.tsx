...
export default function FAQPage() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Full refund if you cancel more than 30 days before departure. After that, refunds decrease on a sliding scale. See our booking conditions for the full schedule.",
    },
    {
